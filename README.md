 ...
 -   Публикация в "Yandex Cloud Functions":
	  ...
	  # Если нужно изменить кол-во элементов на странице или другте настройки, поменять их можно в файле appsettings.json проекта "CourtList.Yandex"
	  ...
	  # Выполнить комманду dotnet publish
	  ...
	  # Прикрепить, созданный фрхив, нажать кнопку "Создать версию", в правом верхнем углу
	  # Версия функции создалась по соответствующему адресу
